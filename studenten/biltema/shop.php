...
<body>
    <div class="kontainer">
        ...
        <form class="form-control" action="#" method="post">
            ...
            <label class="form-label">Ange antal</label>
            <input class="form-control" type="text" name="antalet">
        ...
        <?php
            ...
            $antalet = filter_input(INPUT_POST, "antalet");
            $summan = filter_input(INPUT_POST, "summan");

            // Får vi data från formuläret isåfall spara ned
            if ($namn && $pris && $artnr && $antalet) {
                // Klockslag
                ...
                echo "<p class=\"alert alert-success\">Sparat i kundvagnen: <strong>$namn</strong> med pris <strong>$pris:-</strong> och artikelnr <strong>$artnr samt $antalet st av varan</strong></p>";
            }
        ?>
    </div>
</body>
